...
/// The CamerFollower script makes the camera follow another objects position with a smooth effect.
public class CameraFollower : MonoBehaviour
{
    ...
    and t is the how fast we want the camera smoothing to be (variable "CameraSmoothSpeed"). */
    void FixedUpdate()
    {
